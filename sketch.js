...
function setup() {
  ...
  document.getElementById("prompt1").addEventListener("mouseup", function () {
    selectedNewWord("left");
  });
  document.getElementById("prompt2").addEventListener("mouseup", function () {
    selectedNewWord("right");
  });
  document.getElementById("prompt1").addEventListener("change", function () {
    changedPrompt("left");
  });
  document.getElementById("prompt2").addEventListener("change", function () {
    changedPrompt("right");
  });
  ...
  promptsSlider.addEventListener("mouseup", function () {
    askBetweenPrompts();
  });
...
function selectedNewWord(which) {
  ...
  word1 = prompt1.value
    .slice(prompt1.selectionStart, prompt1.selectionEnd)
    .trim();
  ...
  word2 = prompt2.value
    .slice(prompt2.selectionStart, prompt2.selectionEnd)
    .trim();
